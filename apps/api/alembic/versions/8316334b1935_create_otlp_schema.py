...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        CREATE INDEX idx_otel_resources_last_seen ON otel_resources_dim(last_seen);
        COMMENT ON TABLE otel_resources_dim IS 'Resource dimension with hash-based deduplication';
    """)
    ...
    op.execute("""
        ...
        CREATE INDEX idx_otel_logs_time ON otel_logs_fact(time, time_nanos_fraction);
        ...
        CREATE INDEX idx_otel_logs_trace ON otel_logs_fact(trace_id, span_id_hex) WHERE trace_id IS NOT NULL;
        ...
        COMMENT ON TABLE otel_logs_fact IS 'Log records fact table with timestamp+nanos precision';
    """)
    ...
    op.execute("""
        ...
        CREATE INDEX idx_otel_log_attrs_string_log ON otel_log_attrs_string(log_id);
        CREATE INDEX idx_otel_log_attrs_string_key ON otel_log_attrs_string(key_id);
        CREATE INDEX idx_otel_log_attrs_string_value ON otel_log_attrs_string(value);
        ...
        CREATE INDEX idx_otel_log_attrs_int_log ON otel_log_attrs_int(log_id);
        CREATE INDEX idx_otel_log_attrs_int_key ON otel_log_attrs_int(key_id);
        CREATE INDEX idx_otel_log_attrs_int_value ON otel_log_attrs_int(value);
        ...
        CREATE INDEX idx_otel_log_attrs_double_log ON otel_log_attrs_double(log_id);
        CREATE INDEX idx_otel_log_attrs_double_key ON otel_log_attrs_double(key_id);
        CREATE INDEX idx_otel_log_attrs_double_value ON otel_log_attrs_double(value);
        ...
        CREATE INDEX idx_otel_log_attrs_bool_log ON otel_log_attrs_bool(log_id);
        CREATE INDEX idx_otel_log_attrs_bool_key ON otel_log_attrs_bool(key_id);
        CREATE INDEX idx_otel_log_attrs_bool_value ON otel_log_attrs_bool(value);
        ...
        CREATE INDEX idx_otel_log_attrs_bytes_log ON otel_log_attrs_bytes(log_id);
        CREATE INDEX idx_otel_log_attrs_bytes_key ON otel_log_attrs_bytes(key_id);

        CREATE TABLE otel_log_attrs_other (
            log_id BIGINT NOT NULL PRIMARY KEY REFERENCES otel_logs_fact(log_id) ON DELETE CASCADE,
            attributes JSONB NOT NULL
        );
        CREATE INDEX idx_otel_log_attrs_other_gin ON otel_log_attrs_other USING gin(attributes);
    """)
    ...
    op.execute("""
        ...
        CREATE INDEX idx_otel_spans_time ON otel_spans_fact(start_time, start_time_nanos_fraction);
        ...
        COMMENT ON TABLE otel_spans_fact IS 'Span fact table with timestamp+nanos precision';
    """)
    ...
    op.execute("""
        ...
        CREATE INDEX idx_otel_span_attrs_string_span ON otel_span_attrs_string(span_id);
        CREATE INDEX idx_otel_span_attrs_string_key ON otel_span_attrs_string(key_id);
        CREATE INDEX idx_otel_span_attrs_string_value ON otel_span_attrs_string(value);
        ...
        CREATE INDEX idx_otel_span_attrs_int_span ON otel_span_attrs_int(span_id);
        CREATE INDEX idx_otel_span_attrs_int_key ON otel_span_attrs_int(key_id);
        CREATE INDEX idx_otel_span_attrs_int_value ON otel_span_attrs_int(value);
        ...
        CREATE INDEX idx_otel_span_attrs_double_span ON otel_span_attrs_double(span_id);
        CREATE INDEX idx_otel_span_attrs_double_key ON otel_span_attrs_double(key_id);
        CREATE INDEX idx_otel_span_attrs_double_value ON otel_span_attrs_double(value);
        ...
        CREATE INDEX idx_otel_span_attrs_bool_span ON otel_span_attrs_bool(span_id);
        CREATE INDEX idx_otel_span_attrs_bool_key ON otel_span_attrs_bool(key_id);
        CREATE INDEX idx_otel_span_attrs_bool_value ON otel_span_attrs_bool(value);
        ...
        CREATE INDEX idx_otel_span_attrs_bytes_span ON otel_span_attrs_bytes(span_id);
        CREATE INDEX idx_otel_span_attrs_bytes_key ON otel_span_attrs_bytes(key_id);
    ...
    op.execute("""
        ...
        COMMENT ON VIEW v_otel_logs_enriched IS 'Enriched logs view with all attributes aggregated';
    """)
    ...
    op.execute("""
        ...
        COMMENT ON VIEW v_otel_spans_enriched IS 'Enriched spans view with all attributes aggregated';
    """)
