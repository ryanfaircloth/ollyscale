...
```sql
COMMENT ON TABLE logs_fact IS 'OTLP log records with full nanosecond timestamp precision';
COMMENT ON COLUMN logs_fact.time_nanos_fraction IS 'Remaining nanoseconds (0-999) beyond microsecond precision';
